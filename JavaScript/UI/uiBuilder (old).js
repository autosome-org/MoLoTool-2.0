var uiBuilderOld = (function () {
    ...
    var getObjectsToDisable = function () {
        return $(".search-container")
            .find("input")
            .add("#clear-button, #demo-button"); // ToDo Make these buttons
    };
    ...
    var inputCallback = function (inputString, replaceCurrent, status) {
        ...
        $("#manual-seq-input").find("textarea").val(inputParsedInto); // ToDo change interaction with text areas
    ...
    var buildExternalMotifPickerComponent = function () {
        $('#motif-list').on('click', '.motif-title', function (event) {
            ...
            var $closeButton = $('<a href="#" class="close md-dark material-icons link-button"></a>');
            ...
            $motifContainer.appendTo('#motif-list-selected'); // ToDo motif list
        ...
        $('body').click(function (event) {
            ...
            if (!$target.closest('.collection-dialog, .collection-settings').length) {
                ...
                if (collectionDialog.is(":visible")) {
